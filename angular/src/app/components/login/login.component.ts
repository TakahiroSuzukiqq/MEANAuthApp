...
export class LoginComponent implements OnInit {
  ...
  onLoginSubmit(){
    ...
    this.authService.authenticateUser(user).then(data => {//##Error in Part8: change here to fix the error`error TS2339: Property 'success' does not exist on type 'Object'.`  
